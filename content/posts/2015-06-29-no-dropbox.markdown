...
У каждого файла и директории появился дубликат с расширением `/com.dropbox.attributes`. Как выяснилось позже, причиной стало то, что файлы синхронизировались между различными файловыми системами. И судя по отзывам на форуме Dropbox, и ответам их специалистов, проблема существует давно и должна проявляться только в том случае, если в синхронизации участвуют файловые системы не поддерживающие расширенные атрибуты файлов (к примеру Fat32). Но у меня то использовались HFS и NTFS, обе файловые системы поддерживающие расширенные атрибуты. Откуда взялись дубликаты?? Не понятно.
