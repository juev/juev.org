...
- [Введение](#введение)
- [Проблема: потеря client IP в контейнере](#проблема-потеря-client-ip-в-контейнере)
- [Почему фильтрация только по IP недостаточна](#почему-фильтрация-только-по-ip-недостаточна)
- [Варианты решения](#варианты-решения)
- [Два финалиста](#два-финалиста)
- [Socket activation](#socket-activation)
- [Два Caddy с Tailscale sidecar](#два-caddy-с-tailscale-sidecar)
- [Сравнение вариантов](#сравнение-вариантов)
- [Реализация: переход на два Caddy](#реализация-переход-на-два-caddy)
- [Итоги](#итоги)
- [Источники](#источники)
