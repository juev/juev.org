...
Один раз мне удалось установить <strong>stumpwm</strong> непосредственно из <em>AUR</em>. Я об этом описывал в статье <a href="http://www.juev.ru/2009/08/15/ustanovka-stumpwm/">Установка StumpWM</a>.
...
exec /home/git/stumpwm/stumpwm</code></pre>
...
Мой файл конфигурации stumpwm можно найти по адресу <a href="http://github.com/Juev/stumpwm-config">github.com/Juev/stumpwm-config</a>
