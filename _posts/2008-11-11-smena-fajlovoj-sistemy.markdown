...
<pre>$ tar --one-file-system -cpf /home/user/root.tar --exclude=/proc --exclude=/lost+found --exclude=/mnt --exclude=/sys /</pre>
...
<pre>$ tune2fs -O +dir_index /dev/sda3
$ e2fsck -Df /dev/sda3</pre>
