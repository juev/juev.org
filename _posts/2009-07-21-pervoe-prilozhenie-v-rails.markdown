...
---
О том, как устанавливать Ruby on Rails в Archlinux я уже писал в заметке <a href="http://www.juev.ru/2009/07/15/ruby-on-rails/">Ruby on Rails</a>. А сегодня покажу, как создать первую заготовку в Rails.
