...
[![nvalt][]{:class="aligncenter"}][3]{:id="lightbox"}
...
Помимо расширения есть и [nvALT Bookmarklet][]{:rel="nofollow"}, который можно использовать в любом браузере, а задавать настройки самого букмарклета можно изменяя непосредственно его код.
