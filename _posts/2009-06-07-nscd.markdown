...
<pre><code>$ sudo /etc/rc.d/nscd start</code></pre>
...
<pre>DAEMONS=(syslog-ng crond hal iptables network !netfs hddtemp sensors <strong>nscd</strong> alsa mpd mpdscribble xinetd preload fam slim)</pre>
